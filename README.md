...
| `exports/hualien_post_eq_ndvi.tif` | S8 匯出的震後 NDVI GeoTIFF |
| `exports/hualien_delta_ndvi.tif` | S8 匯出的 Delta-NDVI GeoTIFF |
...
| 檔案 | 說明 |
|---|---|
| `exports/hualien_delta_ndvi.tif` | Delta-NDVI map |
| `exports/hualien_post_eq_ndvi.tif` | Post-earthquake NDVI composite |
